...
Esta instancia tiene el idioma FIJO en español (Web Server 2 según consigna).
La instancia hermana (`aplicacion-web-ingles`) tiene el mismo código pero
con los textos en inglés. No se permite cambiar el idioma desde la UI,
...
IDIOMA_APP = os.getenv("IDIOMA_APP", "es")
...
def _obtener_textos_interfaz():
    """
    Devuelve el diccionario de textos en español.
    La instancia hermana (inglés) usa el mismo template pero con textos
    diferentes; cualquier cambio en el template debe respetar las mismas claves.
    """
    textos_espanol = {
        "titulo_pagina": "Registro Programas de Pregrado",
        "titulo_formulario": "Cuéntanos sobre tu interés",
        "subtitulo": "Universidad EAFIT - Registro de Pregrado",
        "etiqueta_nombre": "Nombre completo",
        "etiqueta_comuna": "Comuna (1 al 10)",
        "etiqueta_carrera": "Carrera de interés",
        "boton_enviar": "Enviar registro",
        "comuna_placeholder": "Selecciona tu comuna",
        "carrera_placeholder": "Selecciona una carrera",
        "pie_servidor": "Atendido por",
        "carreras_traducidas": {
            "Medicina": "Medicina",
...
def _texto_exito():
    return "¡Registro guardado exitosamente. Gracias!"


def _texto_error_servidor():
    return "Hubo un error interno. Por favor intenta de nuevo más tarde."


def _construir_mensaje_error(errores):
    mapa_errores = {
        "nombre_invalido": "Por favor ingresa un nombre válido (mínimo 2 caracteres).",
        "nombre_demasiado_largo": "El nombre es demasiado largo (máximo 150 caracteres).",
        "comuna_invalida": "Por favor selecciona una comuna entre 1 y 10.",
        "carrera_invalida": "Por favor selecciona una carrera válida.",
    }
